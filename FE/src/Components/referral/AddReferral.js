...
function AddReferral() {
  ...
  const [emptymesssage, setemptymessage] = useState(false);
      ...
      <div className="shadow p-4 mb-8 bg-white">
        ...
        <div className="mb-3 row">
          ...
          <div className="col-sm-10">
            <input
              ...
              //       {
              //         console.log("Done")
              //         settotalexperience(false)
              //       }
              //       else{
              //          console.log("Invalid")
              //          settotalexperience(true)
              //       }
            ...
            {/* {totalexperience == true ? (
              <p style={{ color: "red" }}> Please Enter Proper Experience </p>
            ) : (
              false
            )} */}
          </div>
        ...
        <div className="mb-3 row">
          ...
          <div className="col-sm-10">
            ...
            {hrmessage === true ? (
              <p style={{ color: "red" }}>Please Enter Valid Message</p>
            ) : (
              false
            )}

            {emptymesssage === true ? (
              <p style={{ color: "#F1C40F" }}> Please provide the message </p>
            ) : (
              false
            )}
          </div>
